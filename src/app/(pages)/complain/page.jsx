    ...
    <section
      ...
      <div className="container px-5 pb-16 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          ...
          <p
            className="lg:w-2/3 mx-auto leading-relaxed text-base text-centersli"
          >
            Please use this form to submit a complaint or report any issues you have encountered. We value your feedback and strive to address your concerns promptly and fairly. Thank you for your contribution.
          </p>
        </div>
            ...
            <div className="p-2 w-full">
              <div className="relative">
                ...
                >
                  ...
                  >
                    (to contact you later if necessary)
                  </span>
                </label>
                <input
                  onChange={handleChange}
            ...
            <div className="p-2 w-full">
              ...
              <div className="flex items-center">
                <input
                  ...
                  id="link-checkbox"
                  type="checkbox"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 " name='confidential' />
                <label
                  htmlFor="confidential"
                  onClick={handleConfidential}
                  className="ml-2 text-sm font-medium text-gray-600 "
                >
                  Mark this complain as
