        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-4 mx-auto">
                <div className="flex flex-col text-center w-full">
                    <h1
                        className="sm:text-3xl text-2xl font-bold title-font mb-4 text-gray-900 underline underline-offset-4"
                    >
                        FSU Community
                    </h1>
                </div>
                <div className='flex items-center flex-col'>
                    <div className='mb-6'>
                        <div
                            className="imageContainer flex items-center w-32 h-32 md:w-60 md:h-60 relative m-4"
                        >
                            <Image
                        ...
                        <div className="flex flex-col items-center gap-2 ">
                            <h1
                                className="text-gray-900 title-font font-semibold text-2xl"
                            >
                                Nabin Shrestha
                            </h1>
                            <p
                            ...
                            <span className="min-w-[50%] sm:mt-0 flex items-center justify-evenly gap-4">
                                <Link
                                    href="https://www.facebook.com/ishan.stha.98"
                                ...
                                <Link
                                    href="mailto:075bag017@ioepc.edu.np"
                    ...
                    <div className="flex flex-wrap m-2">
                        {details.map((member) => {
                            return (
                                ...
                                >
                                    <span
                                        className=" sm:ml-auto sm:mt-0 flex flex-col absolute right-6 top-2 h-[80%] justify-evenly"
                                    >
                                        {member.fbLink &&
                                            <Link
                                                href={member.fbLink}
