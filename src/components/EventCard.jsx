...
const EventCard = ({ title, desc, img, date, time, eventDate, eventTime, slug }) => {
    ...
    return (
        <div className="p-4 md:w-1/3 relative">
            <span
                className="uppercase bg-red-100 text-red-800 text-xs z-20 font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300 rounded-tl-none rounded-br-none rounded-tr-lg rounder-bl-lg absolute right-4"
            >{status}</span>
            <div
