            ...
            >
                <div className="flex flex-col justify-between  max-w-7xl  text-white items-center z-10">
                    <div className="flex flex-col items-center">
                        ...
                        <span
                            className="underline underline-offset-2 text-white -mt-3"
                        >
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        </span>
                        <div className="flex flex-col text-white mt-5 items-center">
                            <h1
                                className="text-3xl	 md:text-[50px] font-semibold"
                            >
                                स्वतन्त्र विद्यार्थी युनियन,
                            </h1>
                            <p
                                className="text-base mt-2 md:mt-4 tracking-wide"
                            >
                                इ.अ.सं, पूर्वाञ्चल क्याम्पस धरान
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center flex-col">
                        <div className="space-x-3 md:mt-4">
                            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start ">
                                <Link
                                    ...
                                    className="text-blue-700 bg-white rounded-full p-2 hover:bg-blue-700 hover:text-white"
                                >
                                    <svg
                                        fill="currentColor"
                                        strokeLinecap="round"
                                ...
                                <Link
                                    ...
                                    className="text-blue-700 bg-white rounded-full p-2 ml-4 hover:bg-blue-700 hover:text-white"
                                >
                                    <svg
                        ...
                        >
                            ...
                            >
                                <button
                                    className="bg-white text-blue-600 px-6 py-2 hover:brightness-50 font-semibold"
                                >
                                    Explore
                                </button>
                            </Link>
                            ...
                            >
                                <button
                                    className="bg-blue-900 text-white border-2 border-white px-6 py-2 hover:brightness-50 font-semibold"
                                >
                                    Contact Us
                                </button>
                            </Link>
