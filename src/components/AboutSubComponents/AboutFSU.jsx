    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div
                        class="lg:flex-grow flex flex-col md:items-start md:text-left md:mb-0 items-center text-center sm:m-2 md:m-4 lg:m-12"
                    >
                        <h1
                            class={`${props.headingCss} title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900 underline underline-offset-4 xs:text-center w-[100%] `}
                        >{props.title}</h1>
                        <div>
                            <Image
                                className={`rounded float-${props.float} mx-4`}
                                alt="hero"
